...
class BotAppBoxLayout(BoxLayout):
    def __init__(self, **kwargs):
        super(BotAppBoxLayout, self).__init__(**kwargs)
        ...
        self.time_input = TextInput(text='23:40', multiline=False, font_size=18)
